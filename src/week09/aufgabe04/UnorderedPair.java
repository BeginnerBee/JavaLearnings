...
public class UnorderedPair<T> implements Pair {
    ...
    public int compareTo(Object obj) {
        UnorderedPair o = (UnorderedPair) obj;
        if (first.hashCode() > o.getFirst().hashCode() && second.hashCode() > o.getSecond().hashCode())
            return 1;
        else if (first.hashCode() < o.getFirst().hashCode() && second.hashCode() < o.getSecond().hashCode())
            return -1;
        else
            return 0;
    }
